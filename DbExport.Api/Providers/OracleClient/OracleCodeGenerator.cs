...
public class OracleCodeGenerator : CodeGenerator
{
    ...
    protected override string GetTypeName(Column column) =>
        column.ColumnType switch
        {
            ...
            ColumnType.BigInt or ColumnType.UnsignedBigInt => "NUMBER(19)",
            ColumnType.Currency => "NUMBER(16, 4)",
            ...
            ColumnType.SinglePrecision => "NUMBER(12, 4)",
            ColumnType.DoublePrecision => "NUMBER(24, 8)",
