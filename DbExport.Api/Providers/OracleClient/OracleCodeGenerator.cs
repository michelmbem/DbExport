...
public class OracleCodeGenerator : CodeGenerator
{
    ...
    {
        Write($" GENERATED BY DEFAULT AS IDENTITY (START WITH {column.IdentitySeed}, INCREMENT BY {column.IdentityIncrement})");
    }

    /// <inheritdoc/>
    /// <remarks>Oracle does not support ON UPDATE</remarks>
