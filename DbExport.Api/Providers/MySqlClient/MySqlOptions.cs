...
public class MySqlOptions
{
    ...
    public static string[] GetSortOrders(string charset) =>
        charset switch
        {
            ...
            "latin1" =>
            [
                "latin1_bin", "latin1_danish_ci", "latin1_general_ci", "latin1_general_cs", "latin1_german1_ci",
            ...
            "ucs2" =>
            [
                "ucs2_bin", "ucs2_czech_ci", "ucs2_danish_ci", "ucs2_esperanto_ci", "ucs2_estonian_ci",
                "ucs2_general_ci", "ucs2_hungarian_ci", "ucs2_icelandic_ci", "ucs2_latvian_ci",
                "ucs2_lithuanian_ci", "ucs2_persian_ci", "ucs2_polish_ci", "ucs2_roman_ci", "ucs2_romanian_ci",
                "ucs2_slovak_ci", "ucs2_slovenian_ci", "ucs2_spanish2_ci", "ucs2_spanish_ci", "ucs2_swedish_ci",
                "ucs2_turkish_ci", "ucs2_unicode_ci"
            ],
            "ujis" => ["ujis_bin", "ujis_japanese_ci"],
            "utf8" =>
            [
                "utf8_bin", "utf8_czech_ci", "utf8_danish_ci", "utf8_esperanto_ci", "utf8_estonian_ci",
                "utf8_general_ci", "utf8_hungarian_ci", "utf8_icelandic_ci", "utf8_latvian_ci",
                "utf8_lithuanian_ci", "utf8_persian_ci", "utf8_polish_ci", "utf8_roman_ci", "utf8_romanian_ci",
    ...
    public string ToMarkdown() => $"""
                                  | Storage Engine | Character Set | Sort Order |
                                  |----------------|---------------|------------|
                                  | {StorageEngine} | {CharacterSet} | {SortOrder} |
                                  """;
}